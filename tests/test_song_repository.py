...
def test_update_song_tags_refreshes_metadata_fields(monkeypatch, tmp_path) -> None:
    database_path = tmp_path / "blindup.db"
    monkeypatch.setattr(
        db_module,
        "settings",
    ...
    monkeypatch.setattr(
        song_repository,
        "_timestamp",
        lambda: "2026-03-17T11:45:00+00:00",
    )
    ...
    updated = song_repository.get_song_by_id(1)
